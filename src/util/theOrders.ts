...
export const OrderDetails = [
  {
    ...
    "paired_order_id": 16,
    "attunement": "light",
    "description": "the order of power are one of the oldest orders and fixtures of the history of the realms. they compete by working harder and smarter than everyone else, are natural leaders, and have endless self-confidence. their confidence can also be their greatest weakness.",
    "wonders": {
       "name": [
 ...
 },
  {
    ...
    "paired_order_id": 11,
    "attunement": "light",
    "description": "the order of brilliance believes that true perfection lies in the school of thought. they are renowned for their academies, in which they provide basic education in order to find the most promising minds. in the lifelong pursuit of knowledge they catalog and store the history of the realms and conduct extensive research into mana usage.",
    "wonders": {
       "name": [
          "cathedral of agony",
          "infinity spire",
 ...
 },
  {
    ...
    "paired_order_id": 9,
    "attunement": "light",
    "description": "the order of protection values stability between the realms, they wish to build economies to help feed and clothe the destitute. they will often create neutral zones such as inns whereby adventurers can rest at ease. their desire to do good can often be their downfall, as not all pay kindness for kindness, especially those of the dark.  ",
    "wonders": {
       "name": [
          "the exalted basin",
          "the exalted maple",
 ...
 },
  {
    ...
    "paired_order_id": 6,
    "attunement": "dark",
    "description": "the order of fury values extreme and overwhelming force in all situations. they have a need to dominate, and if they cannot dominate, to destroy it with utter frenzied rage. the order of fury has little care for life itself, only the ability to end a life. their disciples are pitted against each other over years until only the most vicious remain. the nature of the order ensures competency, but destroys its own power structures constantly due to infighting and assasinations.",
    "wonders": {
       "name": [
 ...
 },
  {
    ...
    "paired_order_id": 5,
    "attunement": "dark",
    "description": "the order of vitriol loves debate and offers their opinions with complete disregard to the feelings of others. from an early age they face ruthless criticism from their teachers, parents, and leaders. they hold both themselves and others to impossible standards.",
    "wonders": {
       "name": [
          "sky mast",
          "the perpetual fjord",
 ...
 },
  {
    ...
    "paired_order_id": 4,
    "attunement": "dark",
    "description": "the order of the fox thrives off of mischief and competition. they can hide, then are sly, they compete with cunning and trickery, not raw strength. the children of the fox play tricks on other orders, and with age those trucks become increasingly severe.",
    "wonders": {
       "name": [
          "altar of the void",
          "the ancient lagoon",
