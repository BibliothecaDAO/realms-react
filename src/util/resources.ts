...
export const Resources: Array<Resources> = [
  ...
  },
  {
    ...
    value: 594,
    colour: "#fca5a5",
    colourClass: "border-red-300 bg-gradient-to-r from-red-500 via-purple-100 to-yellow-200 text-red-800",
    id: 10,
    description:
  ...
  },
  {
    ...
    value: 55,
    colour: "#1e3a8a",
    colourClass: "border-green-800 bg-gradient-to-r from-green-900 to-yellow-500",
    id: 20,
    description:
