            ...
            <div className="flex flex-col w-full text-sm">
              ...
              <div className="w-full bg-gray-200 rounded">
                <div
                  ...
                  style={{width: (props.data.realm.regions as any / 7) * 100}}
                ></div>
              </div>
              ...
              <div className="w-full bg-gray-200 rounded">
                <div
                  ...
                  style={{width: (props.data.realm.cities as any / 7) * 100}}
                ></div>
              </div>
              ...
              <div className="w-full bg-gray-200 rounded">
                <div
                  ...
                  style={{width: (props.data.realm.harbours as any / 7) * 100}}
                ></div>
              </div>
              ...
              <div className="w-full bg-gray-200 rounded">
                <div
                  ...
                  style={{width: (props.data.realm.rivers as any / 7) * 100}}
                ></div>
              </div>
            </div>
          </div>
