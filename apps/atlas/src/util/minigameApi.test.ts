...
describe('Dynamic element balancing', () => {
  it('calculates next mint amount for light when dark minted more', () => {
    const light = 10000;
    const dark = 40000;
  ...
  it('calculates next mint amount for light when light minted more', () => {
    const light = 40000;
    const dark = 10000;
    const next = getNextMintAmount({ light, dark }, 'light');
    expect(next).toBe(minimumMint);
  });
  it('calculates next mint amount for dark when light minted more', () => {
    const light = 40000;
    const dark = 10000;
  ...
  it('calculates next mint amount for dark when dark minted more', () => {
    const light = 10000;
    const dark = 40000;
    const next = getNextMintAmount({ light, dark }, 'dark');
    expect(next).toBe(minimumMint);
  });
  it('uses minimum amount', () => {
