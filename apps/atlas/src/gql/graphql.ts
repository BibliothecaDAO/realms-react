...
export type GetRealmsQuery = { __typename?: 'Query', realms: Array<(
    { __typename?: 'Realm' }
    & { ' $fragmentRefs'?: { 'RealmCardFragment': RealmCardFragment;'RealmOverviewFragment': RealmOverviewFragment } }
  )> };
...
export const GetRealmsDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"getRealms"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"take"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"Float"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"realms"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"take"},"value":{"kind":"Variable","name":{"kind":"Name","value":"take"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"RealmCard"}},{"kind":"FragmentSpread","name":{"kind":"Name","value":"RealmOverview"}}]}}]}},...RealmCardFragmentDoc.definitions,...RealmOverviewFragmentDoc.definitions]} as unknown as DocumentNode<GetRealmsQuery, GetRealmsQueryVariables>;