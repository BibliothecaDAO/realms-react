  ...
  return (
    <div className="absolute top-0 right-0 z-50">
      <div className="relative">
        ...
        <div className="absolute top-0 right-0 w-[calc(100vw-28rem)] h-[2.8px] bg-amber-100  mr-72 pointer-events-none"></div>
        <div className="absolute top-1 right-0 w-[calc(100vw-36rem)] h-[2.2px] bg-amber-100 mr-72 pointer-events-none"></div>
        <TopRightFrame className="absolute top-0 right-0 pointer-events-none w-72 fill-amber-100" />
      </div>
