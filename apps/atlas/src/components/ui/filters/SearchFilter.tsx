...
export function SearchFilter(props: SearchFilterProps) {
  ...
  return (
    <div className="flex items-center justify-center gap-1 p-1 rounded-xl shadow-inner bg-gray-1100 w-72">
      <input
      ...
      <button
        className="flex items-center justify-center p-2 transition-all duration-300 rounded-xl cursor-pointer h-9 hover:bg-gray-300/20"
        onClick={doSubmit}
      >
        <svg
          width="13"
