...
const Journey1Address = '0x17963290db8c30552d0cfa2a6453ff20a28c31a2';
const Journey2Address = '0xcdfe3d7ebfa793675426f150e928cd395469ca53';
...
export function RealmOverviews(props: RealmOverviewsProps) {
  ...
  //   realm.owner === Journey1Address;
  // const isBridgedViaCarrack = (realm: RealmFragmentFragment) =>
  //   realm.owner === Journey2Address;
