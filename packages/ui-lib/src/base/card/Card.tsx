...
export function Card({ children, className }: Props) {
  return (
    <div
      className={`${className} duration-150 transition-all  hover:bg-gray-600/80 flex flex-wrap px-4 pb-4 pt-2 text-gray-600 bg-gray-800/30 rounded shadow-inner group border-off-200/40 border`}
    >
      {children}
    </div>
  );
