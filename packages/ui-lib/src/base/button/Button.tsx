...
const style = {
  ...
  color: {
    primary: {
      bg: `bg-off-200/20 focus:ring-2 focus:ring-offset-2 focus:ring-off-200 focus:ring-offset-off-100`,
      outline: `border-off-200 border-2 text-off-200 active:bg-off-200 active:text-white`,
    },
    success: {
