...
const STYLES = {
  ...
  base: 'relative inline-flex items-center justify-center outline-none select-none text-left outline-none rounded transition duration-150 ease-in-out capitalize hover:-translate-y-0.5 paper',
  active:
